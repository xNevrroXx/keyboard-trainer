...
/***/ "./src/buildJS/modules/authorize.js":
/*!******************************************!*\
  !*** ./src/buildJS/modules/authorize.js ***!
  \******************************************/
...
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ../services */ "./src/buildJS/services.js");
/* harmony import */ var _changeHeader__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./changeHeader */ "./src/buildJS/modules/changeHeader.js");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0,_services__WEBPACK_IMPORTED_MODULE_21__.getProfile)();

          case 2:
            data = _context.sent;

            if (data) {
              (0,_changeHeader__WEBPACK_IMPORTED_MODULE_22__["default"])();
            }
...
/***/ "./src/buildJS/modules/changeHeader.js":
/*!*********************************************!*\
  !*** ./src/buildJS/modules/changeHeader.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function changeHeader() {
  var profileElem = document.querySelector("nav.menu .menu__item_profile"),
...
/***/ "./src/buildJS/modules/initTraining.js":
/*!*********************************************!*\
  !*** ./src/buildJS/modules/initTraining.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _splitText__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./splitText */ "./src/buildJS/modules/splitText.js");
...
function initTraining(chartStatistic) {
  ...
  var buffer = [];
  var specialKeyCodes = ["ControlLeft", "ControlRight", "ShiftRight", "ShiftLeft", "CapsLock", "Backspace", "ContextMenu"];
  var statisticSpeedValueElem = statisticElem.querySelector(".statistic_speed > .statistic__value"),
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (initTraining);

/***/ }),

/***/ "./src/buildJS/modules/keyboard.js":
/*!*****************************************!*\
  !*** ./src/buildJS/modules/keyboard.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function keyboard() {
  ...
  var body = document.getElementsByTagName("body")[0],
      ...
      keys = ["Backquote", "Digit1", "Digit2", "Digit3", "Digit4", "Digit5", "Digit6", "Digit7", "Digit8", "Digit9", "Digit0", "Minus", "Equal", "Backslash", "Tab", "KeyQ", "KeyW", "KeyE", "KeyR", "KeyT", "KeyY", "KeyU", "KeyI", "KeyO", "KeyP", "BracketLeft", "BracketRight", "Backspace", "CapsLock", "KeyA", "KeyS", "KeyD", "KeyF", "KeyG", "KeyH", "KeyJ", "KeyK", "KeyL", "Semicolon", "Quote", "Enter", "ShiftLeft", "KeyZ", "KeyX", "KeyC", "KeyV", "KeyB", "KeyN", "KeyM", "Comma", "Period", "Slash", "ShiftRight", "ControlLeft", "ControlRight", "MetaLeft", "AltLeft", "Space", "AltRight", "ContextMenu"],
      konamiCode = ["ArrowUp", "ArrowUp", "ArrowDown", "ArrowDown", "ArrowLeft", "ArrowRight", "ArrowLeft", "ArrowRight", "KeyB", "KeyA", "Enter"]; // Variables

  var konamiBuffer = []; // Functions

  function checkForKonamiCode(pushToBuffer) {
    konamiBuffer.push(pushToBuffer);
    var stringifiedBuffer = konamiBuffer.slice(-11).toString(),
...
/***/ "./src/buildJS/modules/loginFormListener.js":
/*!**************************************************!*\
  !*** ./src/buildJS/modules/loginFormListener.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _validate__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./validate */ "./src/buildJS/modules/validate.js");
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../services */ "./src/buildJS/services.js");
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              errors = (0,_validate__WEBPACK_IMPORTED_MODULE_22__["default"])(data, false);

              if (Object.keys(errors).length === 0) {
                (0,_services__WEBPACK_IMPORTED_MODULE_23__.signIn)(data);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              errors = (0,_validate__WEBPACK_IMPORTED_MODULE_22__["default"])(data, true);

              if (Object.keys(errors).length === 0) {
                (0,_services__WEBPACK_IMPORTED_MODULE_23__.register)(data);
              } else {// todo show errors
              }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (loginFormListener);

/***/ }),

/***/ "./src/buildJS/modules/loginFormTab.js":
/*!*********************************************!*\
  !*** ./src/buildJS/modules/loginFormTab.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (loginFormTab);
...
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! chart.js */ "./node_modules/chart.js/dist/chart.mjs");
...
function makeChart(chartStatistic) {
  chart_js__WEBPACK_IMPORTED_MODULE_12__.Chart.register.apply(chart_js__WEBPACK_IMPORTED_MODULE_12__.Chart, _toConsumableArray(chart_js__WEBPACK_IMPORTED_MODULE_12__.registerables));
  var canvasContext = document.getElementById('myChart').getContext('2d');
      ...
      scales: {
        x: {
          ticks: {
            ...
            display: true,
            text: "seconds" // callback: function(value: string, index: string, ticks: string) {
            //   return value;
            // }
  ...
  var myChart = new chart_js__WEBPACK_IMPORTED_MODULE_12__.Chart(canvasContext, // @ts-ignore
  config);
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (makeChart);

/***/ }),

/***/ "./src/buildJS/modules/modal.js":
/*!**************************************!*\
  !*** ./src/buildJS/modules/modal.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function initModal(_ref) {
  var modalSelector = _ref.modalSelector,
      activeClass = _ref.activeClass,
      triggerCloseSelector = _ref.triggerCloseSelector,
      triggerOpenSelector = _ref.triggerOpenSelector,
      _ref$callbackOnOpen = _ref.callbackOnOpen,
      callbackOnOpen = _ref$callbackOnOpen === void 0 ? null : _ref$callbackOnOpen,
      _ref$callbackOnClose = _ref.callbackOnClose,
      callbackOnClose = _ref$callbackOnClose === void 0 ? null : _ref$callbackOnClose,
      _ref$next = _ref.next,
  ...
  if (triggerOpenSelector) {
    var triggerElems = document.querySelectorAll(triggerOpenSelector);
  ...
  if (triggerCloseSelector) {
    var _triggerElems = document.querySelectorAll(triggerCloseSelector);

    _triggerElems.forEach(function (triggerElem) {
      triggerElem.addEventListener("click", function () {
...
/***/ "./src/buildJS/modules/plugToImgOnError.js":
/*!*************************************************!*\
  !*** ./src/buildJS/modules/plugToImgOnError.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (plugToImgOnError);

/***/ }),

/***/ "./src/buildJS/modules/scaleElements.js":
/*!**********************************************!*\
  !*** ./src/buildJS/modules/scaleElements.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function scaleElements(container, elements) {
  elements.forEach(function (element) {
    if (!element.classList.contains("modal") && !element.classList.contains("main-navbar")) {
      var scale = Math.min(container.offsetWidth / element.offsetWidth, container.offsetHeight / element.offsetHeight);

      if (scale <= 1 && scale > 0) {
        element.style.transform = "scale(".concat(scale - 0.1, ")");
      }
    }
  });
}

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (scaleElements);

/***/ }),

/***/ "./src/buildJS/modules/splitText.js":
/*!******************************************!*\
  !*** ./src/buildJS/modules/splitText.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function splitText(textElem) {
  textElem.innerHTML = textElem.innerHTML.split("").map(function (_char) {
...
/***/ "./src/buildJS/modules/validate.js":
/*!*****************************************!*\
  !*** ./src/buildJS/modules/validate.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var backendMainUrlStr = "http://localhost:5000";
var backendUrlsObj = {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch('https://www.googleapis.com/books/v1/volumes?q=энциклопедия');
...
function getProfile() {
  return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var accessToken, response, status, isSuccess;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 4;
            _context2.next = 7;
            return axios__WEBPACK_IMPORTED_MODULE_21__["default"].post(backendUrlsObj.posts, {}, {
              headers: {
          ...
          case 12:
            ...
            console.log("response in error: ", _context2.t0);
          ...
          case 21:
            ...
            localStorage.setItem("isAuthorized", "no");
            _context2.next = 25;
            return refreshToken(backendUrlsObj);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 1;
            _context3.next = 4;
            return axios__WEBPACK_IMPORTED_MODULE_21__["default"].post(backendUrlsObj.refreshToken, {
              token: refreshToken
            });
          ...
          case 12:
            ...
            // недействительный/неверный refreshToken
            localStorage.setItem("isAuthorized", "no");
...
function signIn(data) {
  axios__WEBPACK_IMPORTED_MODULE_21__["default"].post(backendUrlsObj.login, data).then(function (response) {
...
function register(data) {
  axios__WEBPACK_IMPORTED_MODULE_21__["default"].post(backendUrlsObj.register, data).then(function () {
...
/*!*****************************!*\
  ...
  \*****************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_initTraining__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/initTraining */ "./src/buildJS/modules/initTraining.js");
/* harmony import */ var _modules_keyboard__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/keyboard */ "./src/buildJS/modules/keyboard.js");
/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/modal */ "./src/buildJS/modules/modal.js");
...
/* harmony import */ var _modules_loginFormTab__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/loginFormTab */ "./src/buildJS/modules/loginFormTab.js");
/* harmony import */ var _modules_loginFormListener__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/loginFormListener */ "./src/buildJS/modules/loginFormListener.js");
/* harmony import */ var _modules_authorize__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/authorize */ "./src/buildJS/modules/authorize.js");
// owm modules
...
window.addEventListener("DOMContentLoaded", function () {
  ...
  (0,_modules_authorize__WEBPACK_IMPORTED_MODULE_8__["default"])();
  var chartStatistic = [];
  ...
  if (window.location.pathname === "/") {
    ...
    (0,_modules_keyboard__WEBPACK_IMPORTED_MODULE_1__["default"])();
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])({
      modalSelector: ".modal_start-print",
      activeClass: "modal_active",
      triggerCloseSelector: ".modal__close-trigger",
      next: function next() {
        var startPrintBtn = modalStartPrint.querySelector(".modal__start-print-btn");
        startPrintBtn.addEventListener("click", handleClick);
        document.addEventListener("keydown", handleKeyDown); // handler functions

        function handleKeyDown(event) {
          if (event.code === "Enter" || event.code === "Space") {
            modalStartPrint.dispatchEvent(new CustomEvent("closeModal"));
            (0,_modules_initTraining__WEBPACK_IMPORTED_MODULE_0__["default"])(chartStatistic);
    ...
    (0,_modules_loginFormTab__WEBPACK_IMPORTED_MODULE_6__["default"])();
    (0,_modules_loginFormListener__WEBPACK_IMPORTED_MODULE_7__["default"])();
  }
});
})();
